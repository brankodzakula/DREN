...
_$SleepScheduleImpl _$$SleepScheduleImplFromJson(Map<String, dynamic> json) =>
    _$SleepScheduleImpl(
      ...
      stopFluidsTime: const TimeOfDayConverter()
          .fromJson(json['stopFluidsTime'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$SleepScheduleImplToJson(_$SleepScheduleImpl instance) =>
    <String, dynamic>{
      ...
      'stopFluidsTime':
          const TimeOfDayConverter().toJson(instance.stopFluidsTime),
      'targetSleepHours': instance.targetSleepHours,
    };
