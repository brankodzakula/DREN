abstract class Routes {
  ...
  static const today = '/main/today';
  static const diet = '/main/diet';
  static const exercise = '/main/exercise';
  static const sleep = '/main/sleep';
  static const foodSearch = '/diet/search';
  static const barcodeScanner = '/diet/scan';
